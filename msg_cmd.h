...
// cmd msg
#define BUY_MSG "BUY %d %s %d %d; %c" // <ORDER_ID> <PRODUCT> <QTY> <PRICE>
#define SELL_MSG "SELL %d %s %d %d; %c" // <ORDER_ID> <PRODUCT> <QTY> <PRICE>
#define AMD_MSG "AMEND %d %d %d; %c" // <ORDER_ID> <QTY> <PRICE>
#define CANCL_MSG "CANCEL %d; %c" // <ORDER_ID>
