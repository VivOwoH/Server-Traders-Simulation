...
int rw_trader(int id, int fd_trader, int fd_exchange) {
    ...
    if (num_bytes == -1) {
        ...
        if (strcmp(cmd, CMD_STRING[BUY]) == 0 &&
                    sscanf(line, BUY_MSG, &order_id, product, &qty, &price, &dummy) == 4) {
            ...
            if (success_order) {
                ...
                order_time++; // increment counter
                    ...
                    sscanf(line, SELL_MSG, &order_id, product, &qty, &price, &dummy) == 4) {
            ...
            if (success_order) {
                ...
                order_time++; // increment counter
                    ...
                    sscanf(line, AMD_MSG, &order_id, &qty, &price, &dummy) == 3) {
            ...
            if (success_order) {
                ...
                order_time++; // increment counter
                    ...
                    sscanf(line, CANCL_MSG, &order_id, &dummy) == 1) {
